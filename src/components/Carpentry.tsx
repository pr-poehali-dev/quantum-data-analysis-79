...
const works = [
  ...
  { icon: "SquareDashed", title: "Полы и паркет", desc: "Укладка, шлифовка и реставрация деревянных полов, паркетной доски и массива." },
  { icon: "PanelTop", title: "Потолки и панели", desc: "Деревянные панели, балки, вагонка — для стен и потолков в классическом и современном стиле." },
  { icon: "Fence", title: "Заборы и террасы", desc: "Террасная доска, деревянные заборы, перголы и навесы для загородных домов." },
  { icon: "Wrench", title: "Реставрация и ремонт", desc: "Восстановление старых изделий из дерева: шлифовка, покраска, замена элементов." },
]
